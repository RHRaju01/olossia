...
export const HeaderSection = memo(({ onAuthModalOpen }) => {
  ...
  return (
    <header className='sticky top-0 z-50 bg-white/95 shadow-sm backdrop-blur-sm transition-all duration-200'>
          ...
          <div className='flex h-20 items-center justify-between'>
            ...
            <div className='relative flex items-center space-x-2'>
              ...
              <div className='compare-dropdown-container relative z-50 hidden sm:block'>
                ...
                {!isMenuOpen && (
                  <CompareDropdown isOpen={isCompareOpen} onClose={() => setIsCompareOpen(false)} />
                )}
              </div>
              ...
              {/* User button */}
              <div className='user-dropdown-container relative z-50 hidden sm:block'>
                <Button
                  variant='ghost'
                  size='icon'
                  className={`rounded-full hover:bg-gray-100 ${
