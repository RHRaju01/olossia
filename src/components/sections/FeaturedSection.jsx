      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-16 text-center'>
          <Button
            ...
            className='rounded-full bg-gradient-to-r from-purple-600 to-pink-600 px-12 py-4 text-lg font-bold text-white shadow-lg transition-all duration-300 hover:from-purple-700 hover:to-pink-700 hover:shadow-xl'
          >
