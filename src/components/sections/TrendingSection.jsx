  ...
  return (
    <section className='bg-white py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='relative mb-16 flex flex-col md:items-center lg:flex-row lg:justify-between'>
          <div className='flex flex-col max-lg:items-center lg:flex-row lg:justify-center'>
