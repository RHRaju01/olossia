  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative mb-16 flex flex-col lg:flex-row md:items-center lg:justify-between">
          <div className="flex flex-col lg:flex-row max-lg:items-center lg:justify-center">
            <div className="flex flex-col max-lg:items-center sm:justify-center">
