      ...
      <div className='flex min-h-screen items-center justify-center bg-gray-50'>
        <Card className='mx-4 w-full max-w-md p-8'>
          <div className='text-center'>
            ...
            <h2 className='mb-2 text-xl font-semibold text-gray-900'>Error Loading Profile</h2>
              ...
              <CardContent className='p-0'>
                ...
                <div className='border-t border-gray-100 p-4'>
                  <Button
                    ...
                    className='w-full justify-start rounded-xl hover:border-red-200 hover:bg-red-50 hover:text-red-600'
                  >
                    ...
                    return (
                      ...
                      >
                        <div className='mb-4 flex items-start justify-between'>
                          ...
                          <Badge
                            className={`${getStatusColor(order.status)} border-0 font-semibold`}
                          >
              ...
              <Card className='rounded-2xl border-0 shadow-lg'>
                ...
                <CardContent className='space-y-6'>
                  {mockAddresses.map(address => (
                    <div key={address.id} className='rounded-xl border border-gray-200 p-6'>
                      <div className='mb-4 flex items-start justify-between'>
